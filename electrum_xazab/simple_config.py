...
class SimpleConfig(Logger):
    ...
    def electrum_path(self):
        ...
        self.logger.info(f"electrum-xazab directory {path}")
        return path
    ...
    def convert_version_3(self):
        ...
        if isinstance(base_unit, str):
            ...
            map_ = {'xazab':8, 'mxazab':5, 'uxazab':2, 'duffs':0, 'sat':0}
...
def read_user_config(path):
    """Parse and store the user config settings in electrum-xazab.conf into user_config[]."""
    if not path:
        return {}
