...
from electrum_xazab.gui.qt.util import WaitingDialog, EnterButton, WindowModalDialog, read_QIcon
from electrum_xazab.i18n import _
from electrum_xazab.logging import get_logger

if TYPE_CHECKING:
    from electrum_xazab.gui.qt.transaction_dialog import TxDialog
