...
from electrum_xazab.crypto import sha256d, EncodeAES_base64, EncodeAES_bytes, DecodeAES_bytes, hmac_oneshot
from electrum_xazab.bitcoin import public_key_to_p2pkh
from electrum_xazab.bip32 import BIP32Node, convert_bip32_intpath_to_strpath, is_all_public_derivation
from electrum_xazab import ecc
from electrum_xazab.ecc import msg_magic
from electrum_xazab.wallet import Standard_Wallet
from electrum_xazab import constants
from electrum_xazab.transaction import Transaction, PartialTransaction, PartialTxInput
from electrum_xazab.i18n import _
from electrum_xazab.keystore import Hardware_KeyStore
from electrum_xazab.util import to_string, UserCancelled, UserFacingException, bfh
from electrum_xazab.base_wizard import ScriptTypeNotSupported, HWD_SETUP_NEW_WALLET
from electrum_xazab.network import Network
from electrum_xazab.logging import get_logger
from electrum_xazab.plugin import runs_in_hwd_thread, run_in_hwd_thread
...
class DigitalBitbox_Client(HardwareClientBase):
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("Xazab-Electrum-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
