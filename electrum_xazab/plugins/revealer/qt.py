...
from electrum_xazab.util import make_dir, InvalidPassword, UserCancelled
from electrum_xazab.gui.qt.util import (read_QIcon, EnterButton, WWLabel, icon_path,
                                       WindowModalDialog, Buttons, CloseButton, OkButton)
from electrum_xazab.gui.qt.qrtextedit import ScanQRTextEdit
from electrum_xazab.gui.qt.main_window import StatusBarButton
...
class Plugin(RevealerPlugin):
    ...
    def password_dialog(self, msg=None, parent=None):
        from electrum_xazab.gui.qt.password_dialog import PasswordDialog
    ...
    def calibration_pdf(self, image):
        ...
        painter.drawText(700, 2277, _("2. Align your Revealer borderlines to the xazabed lines on the top and left."))
    ...
    def overlay_marks(self, img, is_cseed=False, calibration_sheet=False):
        ...
        if not calibration_sheet:
            if is_cseed: #its a secret
                painter.setPen(QPen(Qt.black, 1, Qt.XazabDotDotLine))
