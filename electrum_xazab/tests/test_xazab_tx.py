...
from electrum_xazab.xazab_tx import XazabTxError, TxOutPoint, ProTxBase
from electrum_xazab.xazab_tx import (SPEC_PRO_REG_TX, SPEC_PRO_UP_SERV_TX,
...
from electrum_xazab.transaction import BCDataStream
from electrum_xazab.util import bfh, bh2u, create_and_start_event_loop
from electrum_xazab.commands import Commands
...
class TestXazabTx(SequentialTestCase):
...
class TestXazabSpecTxSerialization(SequentialTestCase):
    ...
    def test_xazab_tx_cb_tx_v2(self):
    ...
    def test_xazab_tx_pro_reg_tx(self):
    ...
    def test_xazab_tx_pro_up_serv_tx(self):
    ...
    def test_xazab_tx_pro_up_reg_tx(self):
    ...
    def test_xazab_tx_pro_up_rev_tx(self):
    ...
    def test_xazab_tx_sub_tx_register(self):
    ...
    def test_xazab_tx_sub_tx_topup(self):
    ...
    def test_xazab_tx_sub_tx_reset_key(self):
    ...
    def test_xazab_tx_sub_tx_close_account(self):
    ...
    def test_xazab_tx_unknown_spec_tx(self):
        tx = transaction.Transaction(UNKNOWN_SPEC_TX)
        with self.assertRaises(XazabTxError):
            tx.to_json()

    def test_xazab_tx_wrong_spec_tx(self):
