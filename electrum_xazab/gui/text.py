...
from electrum_xazab.util import format_satoshis
from electrum_xazab.bitcoin import is_address, COIN
...
from electrum_xazab.network import NetworkParameters, TxBroadcastError, BestEffortRequestFailed
from electrum_xazab.interface import ServerAddr
from electrum_xazab.logging import console_stderr_handler
from electrum_xazab.xazab_tx import SPEC_TX_NAMES
...
class ElectrumGui:
    ...
    def __init__(self, config: 'SimpleConfig', daemon: 'Daemon', plugins: 'Plugins'):
        ...
        if not storage.file_exists():
            print("Wallet not found. try 'electrum-xazab create'")
            exit()
    ...
    def network_dialog(self):
        ...
        if out:
            ...
            if out.get('server') or out.get('proxy'):
                proxy = electrum_xazab.network.deserialize_proxy(out.get('proxy')) if out.get('proxy') else proxy_config
