...
from electrum_xazab.xazab_tx import (SPEC_PRO_REG_TX, SPEC_PRO_UP_REV_TX,
                                   RevokeReasons, revoke_reason_str)
from electrum_xazab.protx import (ProRegTxExc, ProTxManagerExc, ProTxMN,
                                 ProTxService)
from electrum_xazab.i18n import _

from .xazab_qt import VTabBar
