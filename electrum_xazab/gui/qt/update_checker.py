...
from electrum_xazab import version
from electrum_xazab import constants
from electrum_xazab import ecc
from electrum_xazab.i18n import _
from electrum_xazab.util import make_aiohttp_session, versiontuple
from electrum_xazab.logging import Logger
from electrum_xazab.network import Network


class UpdateCheck(QDialog, Logger):
    url = "https://raw.githubusercontent.com/xazabevo/electrum-xazab/master/.latest-version"
    download_url = "https://github.com/xazabevo/electrum-xazab/releases"
    ...
    def __init__(self, *, latest_version=None):
        ...
        self.setWindowTitle('Xazab Electrum - ' + _('Update Check'))
    ...
    def update_view(self, latest_version=None):
        if latest_version:
            ...
            if self.is_newer(latest_version):
                ...
                self.detail_label.setText(_("You are already on the latest version of Xazab Electrum."))
        else:
            self.heading_label.setText('<h2>' + _("Checking for updates...") + '</h2>')
            self.detail_label.setText(_("Please wait while Xazab Electrum checks for available updates."))
