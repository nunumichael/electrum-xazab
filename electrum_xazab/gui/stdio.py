...
from electrum_xazab import WalletStorage, Wallet
...
from electrum_xazab.network import TxBroadcastError, BestEffortRequestFailed
from electrum_xazab.logging import console_stderr_handler
from electrum_xazab.xazab_ps_util import filter_log_line, PSLogSubCat
...
class ElectrumGui:
    ...
    def network_dialog(self):
        print("use 'electrum-xazab setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-xazab setconfig' to change your settings")
        return True
