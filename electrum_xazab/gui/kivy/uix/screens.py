...
from electrum_xazab.util import profiler, parse_URI, format_time, InvalidPassword, NotEnoughFunds, Fiat
from electrum_xazab.invoices import (PR_TYPE_ONCHAIN, PR_DEFAULT_EXPIRATION_WHEN_CREATING,
                                    PR_PAID, PR_UNKNOWN, PR_EXPIRED, PR_INFLIGHT,
                                    pr_expiration_values, Invoice, OnchainInvoice,
                                    InvoiceExt)
from electrum_xazab import bitcoin, constants
from electrum_xazab.transaction import Transaction, tx_from_any, PartialTransaction, PartialTxOutput
from electrum_xazab.util import parse_URI, InvalidBitcoinURI, TxMinedInfo
from electrum_xazab.wallet import InternalAddressCorruption
from electrum_xazab import simple_config
...
from electrum_xazab.gui.kivy import KIVY_GUI_PATH
from electrum_xazab.gui.kivy.i18n import _

if TYPE_CHECKING:
    from electrum_xazab.gui.kivy.main_window import ElectrumWindow
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from electrum_xazab.util import create_bip21_uri
        amount = self.amount
        if amount:
