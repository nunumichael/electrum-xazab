...
from electrum_xazab.util import is_valid_email
...
#:import ComboBox electrum_xazab.gui.kivy.uix.combobox.ComboBox
    ...
    BoxLayout:
        ...
        GridLayout:
            ...
            Label:
                ...
                height: self.texture_size[1] if self.opacity else 0
                font_size: '33sp'
                font_name: 'electrum_xazab/gui/kivy/data/fonts/tron/Tr2n.ttf'
        GridLayout:
            cols: 1
            id: crcontent
            spacing: '1dp'
...
class RestoreSeedDialog(WizardDialog):
    ...
    def __init__(self, wizard, **kwargs):
        ...
        from electrum_xazab.mnemonic import Mnemonic
        from electrum_xazab.old_mnemonic import wordlist as old_wordlist
    ...
    def update_next_button(self):
        from electrum_xazab.keystore import bip39_is_checksum_valid
        text = self.get_text()
        if self.is_bip39:
