...
#:import SpinBox electrum_xazab.gui.kivy.uix.spinbox.SpinBox
...
<EXWarnPopup@Popup>
    ...
    BoxLayout:
        ...
        orientation: 'vertical'
        Image:
            source:'atlas://electrum_xazab/gui/kivy/theming/light/error'
            size_hint_y: 0.1
        Label:
            size_hint_y: 0.4
            id: warn_msg
...
<PSMixingTab@BoxLayout>
    ...
    ScrollView:
        GridLayout:
            ...
            CardSeparator
            SettingsItem:
                title: root.keep_amount_text + ': %s Xazab' % root.keep_amount
