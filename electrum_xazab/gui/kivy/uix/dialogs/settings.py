...
from electrum_xazab.util import base_units_list
from electrum_xazab.i18n import languages
from electrum_xazab.gui.kivy.i18n import _
from electrum_xazab.plugin import run_hook
from electrum_xazab import coinchooser
...
#:import messages electrum_xazab.gui.messages

<SettingsDialog@Popup>
    id: settings
    title: _('Xazab Electrum Settings')
    has_pin_code: False
        ...
        ScrollView:
            GridLayout:
                ...
                SettingsItem:
                    ...
                    description: _("Base unit for Xazab amounts.")
