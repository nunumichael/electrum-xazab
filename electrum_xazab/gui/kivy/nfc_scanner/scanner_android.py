...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        '''
        return NdefRecord.createApplicationRecord(JString("org.xazab.electrum.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.xazab.electrum"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.xazab.electrum:externalType",
                '',
                data)
        return extRecord
