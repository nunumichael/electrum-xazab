...
from electrum_xazab.wallet import Wallet, create_new_wallet
from electrum_xazab.wallet_db import WalletDB
from electrum_xazab.commands import Commands
from electrum_xazab.util import create_and_start_event_loop, log_exceptions


loop, stopping_fut, loop_thread = create_and_start_event_loop()

config = SimpleConfig({"testnet": True})  # to use ~/.electrum-xazab/testnet as datadir
