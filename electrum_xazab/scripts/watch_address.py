...
from electrum_xazab.util import print_msg, create_and_start_event_loop
from electrum_xazab.synchronizer import SynchronizerBase
...
try:
    ...
    print("usage: watch_address <xazab_address>")
    sys.exit(1)
