...
APPDIR="$BUILDDIR/electrum-xazab.AppDir"
...
APPIMAGE="$DISTDIR/Xazab-Electrum-$VERSION-x86_64.AppImage"
...
cp "$PROJECT_ROOT/electrum-xazab.desktop" "$APPDIR/electrum-xazab.desktop"
cp "$PROJECT_ROOT/electrum_xazab/gui/icons/electrum-xazab.png" "$APPDIR/electrum-xazab.png"
