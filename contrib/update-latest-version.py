...
try:
    imp.load_module('electrum_xazab', *imp.find_module('../electrum_xazab'))
    from electrum_xazab import constants, keystore, storage, SimpleConfig
    from electrum_xazab.version import ELECTRUM_VERSION
    from electrum_xazab.gui.qt import update_checker
...
CONFIG_NAME = '.update-last-version-xazab-electrum'
