...
BUILD_DIST_DIR=build/electrum-xazab/dist
BUILD_BIN_DIR=build/electrum-xazab/bin
NAME=Xazab-Electrum
TNAME=Xazab-Electrum-Testnet
DEB_NAME=electrum-xazab
...
if [[ -n $IS_RELEASE ]]; then
    echo electrum-xazab version is $XAZAB_ELECTRUM_VERSION, release build
else
    echo electrum-xazab version is $XAZAB_ELECTRUM_VERSION
fi
mkdir -p dist
